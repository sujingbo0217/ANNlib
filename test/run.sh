...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -lq ../data/data/labels/uni_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_10.txt \
    -lq ../data/data/labels/single_query_10_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_20.txt \
    -lq ../data/data/labels/single_query_20_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_30.txt \
    -lq ../data/data/labels/single_query_30_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_40.txt \
    -lq ../data/data/labels/single_query_40_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_50.txt \
    -lq ../data/data/labels/single_query_50_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_10_base.txt \
    -lq ../data/data/labels/zipf_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_50_base.txt \
    -lq ../data/data/labels/zipf_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_50_base.txt \
    -lq ../data/data/labels/zipf_50_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_100_base.txt \
    -lq ../data/data/labels/zipf_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_100_base.txt \
    -lq ../data/data/labels/zipf_100_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_10_base.txt \
    -lq ../data/data/labels/random_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_50_base.txt \
    -lq ../data/data/labels/random_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_50_base.txt \
    -lq ../data/data/labels/random_50_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    -in ../data/data/sift/sift_base.fvecs:fvecs -m ${m} -ef ${ef} -efc ${efc} -b ${batch} \
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_100_base.txt \
    -lq ../data/data/labels/random_10_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/sift/sift_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_100_base.txt \
    -lq ../data/data/labels/random_100_query_10k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -lb ../data/data/labels/uni_base.txt \
    -lq ../data/data/labels/uni_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_10.txt \
    -lq ../data/data/labels/single_query_10_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_20.txt \
    -lq ../data/data/labels/single_query_20_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_30.txt \
    -lq ../data/data/labels/single_query_30_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_40.txt \
    -lq ../data/data/labels/single_query_40_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/single_base_50.txt \
    -lq ../data/data/labels/single_query_50_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_10_base.txt \
    -lq ../data/data/labels/zipf_10_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_50_base.txt \
    -lq ../data/data/labels/zipf_50_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/zipf_100_base.txt \
    -lq ../data/data/labels/zipf_100_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_10_base.txt \
    -lq ../data/data/labels/random_10_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_50_base.txt \
    -lq ../data/data/labels/random_50_query_1k.txt \
...
./dyn_test -init 200000 -step 200000 -max 1000000 -type float -dist L2 \
    ...
    -q ../data/data/gist/gist_query.fvecs:fvecs -alpha ${alpha} -k ${k} \
    -lb ../data/data/labels/random_100_base.txt \
    -lq ../data/data/labels/random_100_query_1k.txt \
